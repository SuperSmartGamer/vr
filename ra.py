...
def start_new_tmate_session():
    ...
    try:
        ...
        if not session_links:
            ...
            kill_cmd = f"pkill -f 'tmate -S'" # Removed -f flag from pkill pattern
    ...
    while True:
        try:
            ...
            if current_links and discovered_pid:
                ...
                kill_cmd = f"pkill -f 'tmate -S'" # Adjusted pkill pattern
